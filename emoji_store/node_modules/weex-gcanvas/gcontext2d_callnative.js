...
Object.defineProperty(GContext2D.prototype, "globalAlpha", {
    ...
    set : function(value) {
        ...
        //         + ";");
        this.callNative("a" + value.toFixed(6) + ";");
        // }
    }
});

GContext2D.prototype.callNative = function(cmd){
    this._drawCommands += cmd;
  // GLog.d("WebGLCallNative command: " + cmd);
  // 0 means 2D with async mode, 0x20000000 means 2D with sync mode

  // var result = callGCanvasLinkNative(this.componentId, 0x20000000 ,cmd);
  // _native_cmd = "";
...
GContext2D.prototype.scale = function(a, d) {
    ...
    //         + d.toFixed(6) + ";");
    this.callNative("k" + a.toFixed(6) + "," + d.toFixed(6) + ";")
};
...
GContext2D.prototype.rotate = function(angle) {
    ...
    this.callNative("r" + angle.toFixed(6) + ";")
};
...
GContext2D.prototype._concatDrawCmd = function(numArgs, imageInfo,
    ...
    if(numArgs === 3){
        ...
        this.callNative("d" + imageInfo.id + ",0,0,"
            + imageInfo.width + "," + imageInfo.height + ","
            + x + "," + y + "," + imageInfo.width + "," + imageInfo.height + ";")
    }else if(numArgs === 5){
        var x = parseFloat(sx) || 0;
        ...
        this.callNative("d" + imageInfo.id + ","
            + sx + "," + sy + "," + sw + "," + sh + ","
            + dx + "," + dy + "," + dw + "," + dh + ";");
...
GContext2D.prototype.drawImage = function(image, // image
    ...
    {
        GLog.d("luanxuan: before bindimageTexture");
        GBridge.bindImageTexture(that.componentId, image.src, function(e){
            GLog.d("luanxuan: bindImageTexture callback");
            if( !e.error )
            {
...
GContext2D.prototype.render = function(flag) {
    ...
    if (commands !== null && commands !== "") {
        ...
        callGCanvasLinkNative(this.componentId, 0x20000001, commands);
    }
    //  callGCanvasLinkNative(this.componentId, 0x00000001,commands);
};
...
GContext2D.prototype.moveTo = function(x, y, successCallback, errorCallback) {
    this.callNative("g" + x.toFixed(6) + "," + y.toFixed(6) + ";");
...
GContext2D.prototype.lineTo = function(x, y, successCallback, errorCallback) {
    this.callNative("i" + x.toFixed(6) + "," + y.toFixed(6) + ";");
...
GContext2D.prototype.bezierCurveTo = function(cp1x, cp1y, cp2x, cp2y, x, y,
        successCallback, errorCallback) {
    this.callNative("z" + cp1x + "," + cp1y + "," + cp2x + "," + cp2y + "," + x + "," + y + ";");
...
GContext2D.prototype.getImageData = function(x, y, w, h){
  this.render();
  var result =callGCanvasLinkNative(this.componentId, 0x20000001, "R" + x + "," + y + "," + w + "," + h + ";");

  return {"data" : Gbase64ToArr(result)};
}
