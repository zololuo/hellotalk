...
exports.default = {
  ...
  methods: {
    ...
    ontouchstart: function ontouchstart() {
      ...
      this.preY = _universalEnv.isWeex ? e.changedTouches[0].pageY : e.changedTouches[0].pageY - this.size.top;
    ...
    ontouchmove: function ontouchmove(n) {
      var e = arguments[1][0];
      var _y = _universalEnv.isWeex ? e.changedTouches[0].pageY : e.changedTouches[0].pageY - this.size.top;
      this.changeY = e.changedTouches[0].pageY - this.startY;
      // 父容器距离页面顶部的距离 weex环境下要手动计算
      var parentY = _universalEnv.isWeex ? 50 : this.size.top;
      // modal.alert({
      //   message: _y,
      //   duration: 500
      // })
