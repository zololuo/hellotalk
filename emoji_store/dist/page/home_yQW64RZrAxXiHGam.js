...
exports.default = {
  ...
  methods: {
    ...
    ontouchstart: function ontouchstart() {
      ...
      var parentY = isWeb ? this.size.top : 100;
      this.preY = e.changedTouches[0].pageY - parentY;
    ...
    ontouchmove: function ontouchmove(n) {
      ...
      // 父容器距离页面顶部的距离 weex环境下要手动计算
      var parentY = isWeb ? this.size.top : 100;
      var collideIndex = this._getIdByPosition(_y - parentY);
    ...
    ontouchend: function ontouchend(n) {
      ...
      var collideIndex = this._getIdByPosition(this.endY - parentY);
      if (this.lastItem !== null) {
        animation.transition(this.lastItem, {
          styles: {
            transform: 'scale(1)'
