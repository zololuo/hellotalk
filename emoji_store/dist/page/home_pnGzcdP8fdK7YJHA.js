...
exports.default = {
    ...
    methods: {
        ...
        ontouchend: function ontouchend(e) {
            ...
            console.log('goal:' + collideIndex);
            if (collideIndex !== curIndex && collideIndex !== -1) {
                var collideItem = this.cellDoms[collideIndex];
                var _ref = [this.topArr[collideIndex], this.topArr[touchIndex]];
                this.topArr[touchIndex] = _ref[0];
                this.topArr[collideIndex] = _ref[1];

                // [this.copyList[curIndex],this.copyList[collideIndex]] = [this.copyList[collideIndex],this.copyList[curIndex]];
                // this.cellDoms = this.$refs.cell.map(function(item){
                //   return item;
                // }.bind(this));
                var _ref2 = [this.cellDoms[collideIndex], this.cellDoms[curIndex]];
                this.cellDoms[curIndex] = _ref2[0];
                this.cellDoms[collideIndex] = _ref2[1];
                this.movingIndex = collideIndex;
                // console.log(this.cellDoms);
