...
exports.default = {
  ...
  methods: {
    ontouchstart: function ontouchstart(n) {
      ...
      this.dragBoxTop = this.xArr[n].top;
    },
    ...
    ontouchend: function ontouchend(n) {
      this.goalListIndex = this.getGoalListIndex(this.changeY + this.xArr[n].top);
    ...
    getGoalListIndex: function getGoalListIndex(offsetY) {
      console.log(offsetY);
      // 比较ofsetY与各个list的top值，如果offsetY的值大于等于某个list的top+list的高度，返回这个list的索引
      var flag = this.xArr.some(function (element, index) {
        // element.top+
