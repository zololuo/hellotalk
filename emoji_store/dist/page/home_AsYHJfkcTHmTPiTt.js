...
exports.default = {
  data: function data() {
    return {
      emojiList: [{
        title: 'HelloTalk手宝宝0', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝1', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝2', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝3', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝4', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝5', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }, {
        title: 'HelloTalk手宝宝6', imgUrl: 'http://ali-hk-cdn.nihaotalk.com/groupclass/lessonShare/img/img-chat-bn-normal.png'
      }],
  ...
  methods: {
    ...
    ontouchstart: function ontouchstart(e) {
      ...
      // modal.alert({
      //      message: 'preY:'+this.preY+',index:'+this.movingIndex,
      //      duration: 500
      // })
      if (this.movingIndex != -1) {
        this.dragBoxTop = this._getTopValueYById(this.movingIndex);
        this.curItem = this.emojiList[this.movingIndex];
    ...
    ontouchend: function ontouchend(e) {
      ...
      if (collideIndex !== this.movingIndex && collideIndex !== -1) {
        var collideItem = this.cellDoms[collideIndex];
        var _ref = [this.cellDoms[collideIndex], this.cellDoms[this.movingIndex]];
        this.cellDoms[this.movingIndex] = _ref[0];
        this.cellDoms[collideIndex] = _ref[1];
        var _ref2 = [this.emojiList[collideIndex], this.emojiList[this.movingIndex]];
        this.emojiList[this.movingIndex] = _ref2[0];
        this.emojiList[collideIndex] = _ref2[1];
    ...
    _getIdByPosition: function _getIdByPosition(pageY) {
      ...
      this.emojiList.some(function (item, i) {
        if (pageY >= i && pageY < height * (i + 1)) {
          id = i;
          return true;
        };
      });
  ...
  mounted: function mounted() {
    this.$nextTick().then(function () {
      ...
      this.idArr = this.emojiList.map(function (item, index) {
        return index;
      });
    }.bind(this));
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      staticClass: ["cell"],
      style: {
        top: _vm.isWeb ? index * 70 * 2 + 'px' : index * 70,
        width: _vm.fullWidth
      }
    }, [_c('div', {
