...
exports.default = {
  ...
  methods: {
    bind: function bind(box) {
      if (!this.isInArray(this.xArr, box)) {
        box.y = 0;
        this.xArr.push(box);
      }
      _weexBindingx2.default.bind({
    ...
    ontouchstart: function ontouchstart(event) {
      ...
      var box = _universalEnv.isWeex ? event : event.fromElement;
      console.log(event);
      console.log(this.$refs.box);
      console.log(getEl(this.$refs.box));
      this.bind(getEl(this.$refs.box));
    },
...
exports.default = {
  ...
  methods: {
    ...
    ontouchstart: function ontouchstart(event) {
      var box = getEl(event.fromElement);
