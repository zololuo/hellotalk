...
exports.default = {
  ...
  methods: {
    ...
    ontouchstart: function ontouchstart() {
      ...
      this.preY = e.changedTouches[0].pageY - this.size.top;
      modal.toast({
        message: 'prey:' + this.preY + '  startY: ' + this.startY,
        duration: 500
      });
    ...
    ontouchmove: function ontouchmove(n) {
      ...
      var self = this;
      // 需要做距离检测
      var collideIndex = this._getIdByPosition(_y - this.size.top);
    ...
    ontouchend: function ontouchend(n) {
      var e = arguments[1][0];
      this.endY = e.changedTouches[0].pageY;
      var collideIndex = this._getIdByPosition(this.endY - this.size.top);
      if (this.lastItem !== null) {
        animation.transition(this.lastItem, {
          styles: {
            transform: 'scale(1)'
  ...
  mounted: function mounted() {
    this.$nextTick().then(function () {
      ...
      this.getBoundingClientRect(getEl(this.$refs.scroller));
      modal.alert({
        message: this.size,
        duration: 500
      });
