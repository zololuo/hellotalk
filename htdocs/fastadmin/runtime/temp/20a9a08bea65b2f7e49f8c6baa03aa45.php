<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/index/index.html";i:1502881244;s:85:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/common/meta.html";i:1502881244;s:87:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/common/header.html";i:1502881244;s:85:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/common/menu.html";i:1502881244;s:88:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/common/control.html";i:1502881244;s:87:"/Applications/MAMP/htdocs/fastadmin/public/../application/admin/view/common/script.html";i:1502881244;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><?php echo strtoupper(mb_substr($site['name'],0,4,'utf-8')); ?></span>
    <!-- 普通模式下Logo -->
...
<nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="<?php echo url('index/index/index'); ?>" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
            </li>
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="__CDN__<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
