...
/* 										log(data);
		...
		position: function() {
			...
			var pos, tri_h = 0, tri_w = 0, cor_w = 0, cor_h = 0, tri_l, tri_t, tar_l, tar_t, cor_l, cor_t,tar_h,tar_w,s;
			tar_h = this.target.data("height");//height();
			tar_w = this.target.data("width");//data("width");width();
			st = $(window).scrollTop(),
